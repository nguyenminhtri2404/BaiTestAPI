...
builder.Services.AddScoped<IRecordingServices, RecordingServices>();
builder.Services.AddScoped<IPlaybackScheduleServices, PlaybackScheduleServices>();
